/*
 * makeAntSphericalCosineProductsFiles.C

 *  Created on: Jul 04, 2020
 *      Author: John Russell
 *
 *  In contrast to "makeAntSpherCosinesFiles.C", here the products of spherical cosines between antennas
 *  up to two phi sectors apart are calculated.
 */
...
void makeAntSphericalCosineProductsFiles() {
