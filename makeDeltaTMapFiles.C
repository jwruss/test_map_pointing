/*
 * makeDeltaTMapFiles.C

 *  Created on: Jul 05, 2020
 *      Author: John Russell
 *
 *  Since UCorrelator::getDeltaT() involves calculation with trigonometric functions,
 *  perhaps pre-processing the calculated values could be faster to reference?
 */
