...
//		thetaDefault = sum -> mostImpulsivePeak(2).theta;
		...
		TH2D unnormalizedFlatMapPol = makePeakUnnormalizedFlatInterferometricMap(eventNumber, phiRough, -thetaRough, sum -> highestPol());
...
//		delete gROOT -> FindObject("peakFlatResponseMap");
		TH2D unnormalizedFlatMapUnpol = makePeakUnnormalizedFlatInterferometricMap(eventNumber, phiRough, -thetaRough, AnitaPol::kNotAPol);
...
//		delete gROOT -> FindObject("peakFlatResponseMap");
		...
		TH2D unnormalizedMapPol = makePeakUnnormalizedInterferometricMap(eventNumber, phiRough, -thetaRough, sum -> highestPol());
...
//		delete gROOT -> FindObject("peakResponseMap");
		TH2D unnormalizedMapUnpol = makePeakUnnormalizedInterferometricMap(eventNumber, phiRough, -thetaRough, AnitaPol::kNotAPol);
